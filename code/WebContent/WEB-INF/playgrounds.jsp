...
<body>
  ...
  <div id="playgrounds">
    ...
    <a href="javascript:;" onclick="parentNode.submit();" id="playground" style="text-decoration:none;color:black;">
        <div id="leftside"">
       		 <img src="${playground.simg}" alt="image">
       		 <fmt:parseNumber var = "price" integerOnly = "true" type = "number" value = "${playground.price}" />
            <div id="bagasy">от ${price} KZT</div>
        </div>
        <div id="rightside">
